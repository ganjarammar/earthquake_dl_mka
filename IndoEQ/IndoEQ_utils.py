...
# -*- coding: utf-8 -*-
"""
Source: https://github.com/seoungheong/LEQNet/blob/main/LEQNet/JS_EQTransformer/core/EqT_utils.py
...
def _block_CNN_1(filters, ker, drop_rate, activation, padding, use_prelu, inpC):
...
def _encoder(filter_number, filter_size, depth, drop_rate, ker_regul, bias_regul, activation, padding, use_prelu, inpC):
...
class IndoEQ:
    ...
    key_dim: int
        The dimension of the key, default is 32.

    value_dim: Any | None
        The dimension of the value, default is None (same dimension with key).
    ...
    def __call__(self, inp):
        ...
        for cb in range(self.cnn_blocks):
            if cb > 2:
                x = _block_CNN_1(self.nb_filters[4], 2, self.drop_rate, self.activationf, self.padding, self.use_prelu, x)
            else:
                x = _block_CNN_1(self.nb_filters[4], 3, self.drop_rate, self.activationf, self.padding, self.use_prelu, x)
